...
from sfepy.homogenization.recovery import (
    compute_micro_u,
...
def recovery_le(pb, corrs, macro):
    ...
    out["cauchy_strain"] = Struct(name="output_data", mode="cell", data=strain)
    out["cauchy_stress"] = Struct(name="output_data", mode="cell", data=stress_Y)
...
equation_corrs = {
    "balance_of_forces": """dw_lin_elastic.i.Y(mat.D, v, u) =
